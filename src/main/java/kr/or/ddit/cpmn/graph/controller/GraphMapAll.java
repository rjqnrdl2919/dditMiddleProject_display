...
/**
 * Servlet implementation class GraphMapAll
 */
@WebServlet("/api/graph-map-all")
public class GraphMapAll extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		List<GraphVO> graphMapAll = service.selectGraphMapAll();
		resp.setContentType("application/json; charset=UTF-8");
		new Gson().toJson(graphMapAll, resp.getWriter());
	}
}
